const stoppageList = require("express").Router();
...
stoppageList.get('/getGroupName', jsonParser, async (req, res, next) => {
    try {
  ...
  stoppageList.post('/getReason', jsonParser, async (req, res, next) => {
  ...
  stoppageList.post('/addGroupName', jsonParser, async (req, res, next) => {
    try {
  ...
  stoppageList.post('/addReason', jsonParser, async (req, res, next) => {
  ...
  stoppageList.post('/deleteGroup', jsonParser, async (req, res, next) => {
    try {
  ...
  stoppageList.post('/deleteReason', jsonParser, async (req, res, next) => {
